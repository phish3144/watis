(() => {
  ...
  } catch (e) { out.defineProbe = 'THREW:' + e.name }
  try {
    out.wasm = (typeof WebAssembly !== 'undefined')
      ? (() => { try { new WebAssembly.Module(new Uint8Array([0,97,115,109,1,0,0,0])); return 'COMPILED' } catch (e) { return 'THREW:' + e.name } })()
      : 'NO-WEBASSEMBLY';
  } catch (e) { out.wasm = 'THREW:' + e.name }
